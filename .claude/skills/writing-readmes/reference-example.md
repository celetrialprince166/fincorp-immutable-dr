<!--
GOLD-STANDARD REFERENCE — do not edit as project content.
This is the README from celetrialprince166/pongapp, kept verbatim as the
structural model the `writing-readmes` skill imitates. Study its section order,
image placement, alt-text style, table/tree formatting, and measured tone.
-->
